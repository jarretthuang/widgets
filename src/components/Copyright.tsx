...
export default function Copyright() {
  ...
  return (
    <div className="Copyright flex w-fit cursor-pointer flex-row items-center rounded-3xl bg-lime-50 px-8 py-3 font-medium shadow-md backdrop-blur dark:bg-stone-900">
