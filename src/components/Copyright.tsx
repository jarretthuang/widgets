...
export default function Copyright() {
  ...
  return (
    <div className="Copyright flex w-fit cursor-pointer flex-row items-center rounded-3xl bg-white/10 px-8 py-3 font-medium shadow-md backdrop-blur dark:bg-black/20">
