...
export default function Copyright() {
  ...
  return (
    <div className="Copyright flex w-fit cursor-pointer flex-row items-center rounded-3xl bg-white/60 px-5 py-2.5 font-medium shadow-md backdrop-blur dark:bg-teal-900/60">
