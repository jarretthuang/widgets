...
export default function HomeLayout({
  ...
  return (
    <main
      className={`${font.className} relative flex h-fit min-h-svh flex-col items-center justify-between bg-[var(--page-background)] p-4 text-slate-700 md:p-6 dark:text-slate-100`}
    >
