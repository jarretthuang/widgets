    ...
    <div className="flex h-full w-full flex-col">
      ...
      <div className="flex w-full flex-col whitespace-nowrap py-4 md:w-72">
        ...
        <input
          ...
          className="input w-full rounded-lg border-2 border-slate-500 bg-white bg-white/0 p-2 focus:border-slate-400 focus:outline-none dark:border-slate-200 dark:focus:border-gray-400"
          value={stockSymbol}
